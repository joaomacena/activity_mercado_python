...
class Aplicacao:
    ...
    def executar_comando(self, comando):
        ...
        elif comando == '3': #decrementar item 
            self._decrementar_item()
        elif comando == '4': #remover item
            self._remover_items()
        elif comando == '5': #exibir resumo
            self._exibir_resumo()
        else:
            return True
    ...
    def _decrementar_item(self):
        codigo = input('Codigo do item a decrementar(retirar uma UN) do carinho: ')
        self._carrinho.decrementar_item(codigo)

    def _remover_items(self):
        codigo = input('Codigo do item a ser retirado do carinho: ')
